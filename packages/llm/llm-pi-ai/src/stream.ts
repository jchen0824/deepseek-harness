...
/**
 * Classify pi-ai's flattened provider failure without retaining its text.
 * @param message - provider-owned failure text available only inside the adapter.
 * @returns the provider-neutral Harness failure code.
 */
