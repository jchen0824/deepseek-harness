...
import {
  ...
  llmOAuthCancelValueSchema,
  llmOAuthDisconnectValueSchema,
...
export interface IApiClient {
  ...
  llm: {
    ...
    oauthStart(payload: RequestPayload<'llm.oauthStart'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'llm.oauthStart'>>>
    ...
    oauthDisconnect(payload: RequestPayload<'llm.oauthDisconnect'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'llm.oauthDisconnect'>>>
  }
...
const UNARY_VALUE_SCHEMAS: { [K in keyof RpcMethodMap]: z.ZodType<Wire<ResponseValue<K>>> } = {
  ...
  'llm.oauthStart': llmOAuthStartValueSchema,
  'llm.oauthStatus': llmOAuthStatusValueSchema,
  'llm.oauthCancel': llmOAuthCancelValueSchema,
  'llm.oauthDisconnect': llmOAuthDisconnectValueSchema,
}
...
export abstract class AbstractApiClient implements IApiClient {
  ...
  readonly llm: IApiClient['llm'] = {
    ...
    oauthStart: (payload, signal) => this.callUnary('llm.oauthStart', payload, signal),
    ...
    oauthDisconnect: (payload, signal) => this.callUnary('llm.oauthDisconnect', payload, signal),
  }
