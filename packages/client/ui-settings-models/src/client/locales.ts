...
export const en = {
  nav: 'Models',
  title: 'Models',
  intro: 'Connect an account or enter API keys to use models from the following providers.',
  edit: 'Edit',
  ...
  deleteDescriptionOAuth: 'Deleting {provider} disconnects ChatGPT and removes its configuration.',
  ...
  oauthConnect: 'Connect ChatGPT',
  oauthConnecting: 'Connecting',
  oauthConnected: 'Connected',
  oauthReconnect: 'Reconnect',
  oauthDisconnect: 'Disconnect',
  oauthCode: 'Verification code',
  oauthOpen: 'Open verification page',
  oauthCopy: 'Copy code',
  oauthActionFailed: 'The ChatGPT connection could not be updated. Please try again.',
  oauthCopyFailed: 'The verification code could not be copied. Copy it manually instead.',
  oauthRemoveFailed: 'The provider remains configured but is disconnected. Try deleting it again.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  nav: '模型',
  title: '模型',
  intro: '连接帐号或填入各提供方的 API 密钥，即可使用其模型。',
  edit: '编辑',
  ...
  deleteDescriptionOAuth: '删除 {provider} 会断开 ChatGPT 连接并移除其配置。',
  ...
  oauthOpen: '打开验证页面',
  oauthCopy: '复制验证码',
  oauthActionFailed: '无法更新 ChatGPT 连接，请重试。',
  oauthCopyFailed: '无法复制验证码，请手动复制。',
  oauthRemoveFailed: '提供方仍处于已配置但未连接状态，请再次尝试删除。',
